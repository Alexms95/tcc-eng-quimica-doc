...
A 3000 iterações, o estado da malha é apresentado na Figura \ref{fig:MM_surf_3000it_high}. Novamente, o surfactante procura ocupar os espaços nas interfaces entre as células de água e as células de substrato e produto aglomerados (apolares) e, em maior concentração, esse efeito é mais pronunciado. Nota-se a presença de inúmeras células de enzima fora do aglomerado de células de água, o que sugere que a enzima está consideravelmente disponível para reações e que o surfactante pode estar agindo como um facilitador da reação. Esses efeitos são destacados em vermelho na Figura \ref{fig:MM_surf_3000it_high}.
...
A 10000 iterações, o estado da malha é apresentado na Figura \ref{fig:MM_surf_10000it_high}. Nota-se que o surfactante interage fortemente com os aglomerados de produto.
