...
A respeito da interação entre as células das bordas da malha, o modelo adota a condição de contorno toroidal, onde as células da borda se conectam às células opostas. Por exemplo, a célula (0, 0) está conectada à célula (0, 3) e, também, à celula (3, 0), fazendo parte de sua vizinhança de von Neumann. Essa abordagem garante que todas as células tenham vizinhos válidos, independentemente de sua posição na malha. Outras condições de contorno, como cilíndrica ou caixa, também são utilizadas em autômatos celulares, mas a toroidal é a mais comum, pois permite uma simulação contínua e sem bordas. A cilíndrica conecta as células da borda horizontalmente ou verticalmente, enquanto a caixa trata as bordas como paredes fixas, o que pode limitar a dinâmica do sistema. A Figura \ref{fig:torus} ilustra a condição de contorno toroidal aplicada ao modelo. A vizinhança de von Neumann da célula (0, 0) é composta pelas células (0, 1), (1, 0), (3, 0) e (0, 3).
