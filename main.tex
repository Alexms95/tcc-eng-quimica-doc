...
\vspace*{\fill}
\begin{flushright}
    \textit{``A ciência é a arte de fazer perguntas.''} \\
    \textbf{Isaac Asimov}
\end{flushright}
\vspace*{4cm}
