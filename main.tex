...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{X X m{5cm}}
        ...
        2                 & $2{,}956 \cdot 10^{-5}$               & $0{,}0220$              \\
        3                 & $2{,}900 \cdot 10^{-5}$               & $0{,}0213$              \\
        \hline
        \textbf{Final}    & $(2{,}956 \pm 0{,}045) \cdot 10^{-5}$ & $0{,}0224 \pm 0{,}0011$ \\
        \hline
    \end{tabularx}
    \vspace{0.2cm}
    \makebox[\linewidth][l]{\small Fonte: Autoria própria}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{X X m{5cm}}
        ...
        3                 & $2{,}701 \cdot 10^{-5}$               & $0{,}0239$              \\
        \hline
        \textbf{Final}    & $(2{,}576 \pm 0{,}089) \cdot 10^{-5}$ & $0{,}0238 \pm 0{,}0020$ \\
        \hline
    \end{tabularx}
    \vspace{0.2cm}
    \makebox[\linewidth][l]{\small Fonte: Autoria própria}
