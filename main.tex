...
\begin{tabbing}
    CSTR \hspace{2cm} \= Continuous-Stirred Tank Reactor \\
    PP \> Polipropileno \\
...
\begin{tabbing}
    $\cdot$ \hspace{2cm} \= Taxa de reação (mol s\textsuperscript{-1} m\textsuperscript{-3}) \\
    $R$ \> Constante dos gases ideais (J mol\textsuperscript{-1}K\textsuperscript{-1}) \\
