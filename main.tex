...
O software desenvolvido apresenta uma interface gráfica intuitiva, facilitando o uso por pesquisadores e estudantes sem experiência prévia em programação, e permite a configuração detalhada dos parâmetros do sistema, bem como a exportação dos resultados para análise posterior. A integração com banco de dados relacional e a possibilidade de execução remota via API ampliam o potencial de aplicação da ferramenta em diferentes contextos acadêmicos e industriais.
