...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{conc_time.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Vmax_Km.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{LB.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{empty_simulacao.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{running_simulacao.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{result_simulacao.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{example_csv.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{MM_initial.png}
...
A seguir, apresenta-se o gráfico da fração relativa de cada componente ao longo das iterações:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{MM_1000it.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{MM_8000it.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{lineweaver_burk_plot.png}
...
Por esse método, o coeficiente linear da equação, $b$, é utilizado para encontrar o valor de $V_{max}$, que é dado por $V_{max} = \frac{1}{b} \approx 2{,}48 \cdot 10^{-5}$. O coeficiente angular, $a$, é utilizado para encontrar o valor de $K_M$, que é dado por $K_M = \frac{a}{b} \approx 0{,}0162$. Pela razão descrita anteriormente, esse método será desconsiderado para outras simulações.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{MM_apolar_initial.png}
    \hspace{0.5cm}
    \includegraphics[width=0.2\textwidth]{legend.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{apolar_3000.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{apolar_10000.png}
...
Após a execução completa dessa simulação, a matriz inicial gerada é ilustrada na Figura \ref{fig:michaelis_menten_movement_surfactante}. Note as células de surfactante (F) identificadas por meio da legenda e o direcionamento aleatório atribuído a elas, definido pela orientação da ponta do triângulo.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{MM_surf_initial.png}
    \hspace{0.5cm}
    \includegraphics[width=0.15\textwidth]{legend_surf.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{surf_3000.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{surf_10000.png}
